    ...
    for angle in angle_list:
        ...
        for woll_num in range(len(woll_list)): #視点の線分と交点、3Dviewを描写
            ...
            if hitpos != None:
                    ...
                    pygame.draw.line(screen, Blue, (((screen_width/len(angle_list)) * angle_list.index(angle)),1080), (((screen_width/len(angle_list)) * angle_list.index(angle)),610+(50/long)*40),int((screen_width/len(angle_list))))
                    pygame.draw.line(screen, Black, (((screen_width/len(angle_list)) * angle_list.index(angle)),540), (((screen_width/len(angle_list)) * angle_list.index(angle)),470-(50/long)*40),int((screen_width/len(angle_list))))
                    pygame.draw.line(screen, Black, (((screen_width/len(angle_list)) * angle_list.index(angle)),540), (((screen_width/len(angle_list)) * angle_list.index(angle)),610+(50/long)*40),int((screen_width/len(angle_list))))
            elif hitpos == None:
                count += 1
            if count == 4:
                pygame.draw.line(screen, Blue, (((screen_width/len(angle_list)) * angle_list.index(angle)),1080), (((screen_width/len(angle_list)) * angle_list.index(angle)),650),int((screen_width/len(angle_list))))
